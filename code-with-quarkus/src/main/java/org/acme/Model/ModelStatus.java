...
public class ModelStatus {
    private int id_status_usuario;
    private int id_usuario;
    private int desafios_concluidos;
    private int nivel_atual;
    private int xp_atual;
    private int xp_total;

    public ModelStatus(int id_status_usuario, int id_usuario, int desafios_concluidos, int nivel_atual, int xp_atual, int xp_total) {
